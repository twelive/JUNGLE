  ...
  return (
    <>
      ...
      <section>
        ...
        <Schedule title="우리의 여정">
          프론트엔드 스쿨 6기에서 프론트엔드 플러스 스쿨 1기를 지나 어엿한
          주니어 프론트엔드 개발자를 향해 나아가고 있습니다! 특히 이번 주니어
          프론트엔드만을 위한 반응형 웹사이트, `JUNGLE`을 개발하고 배포하면서
          기획부터 디자인, 협업 사항을 상세하게 나누고 GitHub을 통해
          기록하였습니다. 앞으로도 각자 희망하는 도메인 속에서 그려나갈 미래를
          꿈꾸며 노력하겠습니다. 지금까지 팀 Twelive 였습니다. 감사합니다!
        </Schedule>
      </section>
    </>
  );
...
const StyledMemberContainer = styled.ul`
  display: flex;
  align-items: center;
