  ...
  return (
    <>
      ...
      <section>
        ...
        <Schedule isBorder={false}>페이지 성능 개선을 위해 데이터 Store 로직을 Tanstack Query를 이용하여 변경할 계획입니다. 또한 정기적인 정보 업데이트를 통해 언제든지 사용할 수 있는 사이트를 계획하고 있습니다. 지금까지 꿈꾸는 사자들, JUNGLER 였습니다. 감사합니다!</Schedule>
      </section>
    </>
  );
}
